    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('mcq', 'Multiple Choice'), ('true_false', 'True/False'), ('text', 'Text Answer')], default='mcq', max_length=20)),
                ('order', models.IntegerField(default=0)),
                ('correct_text_answer', models.TextField(blank=True, help_text='For text questions, the expected answer', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('taker_name', models.CharField(blank=True, max_length=100, null=True)),
